...
public class ProgressTest extends Game {
	...
	@Override
	public void onLoad(GameSettings arg0) {
	}

	@Override
	public void onRepaint(Graphics graphics) {
		drawProgressBar((Graphics2D) graphics, 0, 0, 200, 25, Color.RED,
				Color.GREEN, 255, 80);

		drawProgressBar((Graphics2D) graphics, 0, 30, 200, 25, Color.GRAY,
				Color.BLUE, 255, 60);

		drawProgressBar((Graphics2D) graphics, 0, 60, 200, 25, Color.ORANGE,
				Color.CYAN, 255, 20);

		drawProgressBar((Graphics2D) graphics, 210, 0, 25, 200, Color.RED,
				Color.GREEN, 255, 80);

		drawProgressBar((Graphics2D) graphics, 240, 0, 25, 200, Color.GRAY,
				Color.BLUE, 255, 40);

		drawProgressBar((Graphics2D) graphics, 270, 0, 25, 200, Color.ORANGE,
				Color.CYAN, 255, 50);
	}

	public void drawProgressBar(Graphics2D g, final int x, final int y,
